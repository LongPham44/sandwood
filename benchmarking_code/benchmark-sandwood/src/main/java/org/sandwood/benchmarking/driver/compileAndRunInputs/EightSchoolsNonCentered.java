...
public class EightSchoolsNonCentered {
    ...
    public static Map<TestType, TestData> getInputs() {
        ...
        Map<TestType, TestData> m = new HashMap<>();
        {
            ...
            t.outputNames = new String[] { "theta_trans", "mu", "tau", "theta" };
    ...
    private static InputStream openObservedData() throws IOException {
        ...
        InputStream in = EightSchoolsNonCentered.class.getClassLoader().getResourceAsStream(resourceName);
        if(in != null)
            return in;
